...
final class Aggregator implements Runnable {
   ...
   * feature discovery and to reset every cardinality handler in lockstep (static property
   * handlers, cached peer-tag schema, additional-tags schema). Running before the flush
